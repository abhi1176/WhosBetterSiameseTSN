...
def train_spatial_model(num_snippets, num_iterations, learning_rate,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--iterations", type=int, default=3500)
    parser.add_argument("-lm", "--margin", type=float, default=MARGIN)
    parser.add_argument("-lb", "--beta", type=float, default=BETA)
    parser.add_argument("-lr", "--learning-rate", type=float, default=SPATIAL_LEARNING_RATE)
